...
def optimize_policy_net(memory: Memory, policy_net: HyperGraphGNN, scheduler: ReduceLROnPlateau, target_net: HyperGraphGNN, optimizer: AdamW, tracker: Tracker, nb_tasks: int, device: Device):
    """
