...
MEMORY_CAPACITY: int     = 50_000 # number of transitions in the replay memory
...
TOP_K: int               = 6      # number of top-Q actions to consider in the Boltzmann exploration
...
PATIENCE: int            = 300    # number of episode without loss improvement before reducing the learning rate
